        ...
        IProfile
{
    ...
    private void setProfileName(){
        TextView uid = findViewById(R.id.text_name);
        uid.setText("Welcome " + (((UserClient)getApplicationContext()).getUser().getUsername())+"!");
    }

    private void retrieveProfileImage(){
        RequestOptions requestOptions = new RequestOptions()
                .error(R.drawable.stock_bg_login)
                .placeholder(R.drawable.stock_bg_login);
